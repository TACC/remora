...
Version 1.4.0 is a new release that adds a modular design that allows to easily configure the functionality available on each site as well as a simple addition of new functionality to the tool. In this release REMORA has also become independent of XLTOP, so Lustre IO data may be captured without the need to install and run third party tools.
