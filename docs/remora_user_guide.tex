...
REMORA is a modular tool to monitor runtime resource utilization in HPC environments. As of version 1.6.0 the suite contains code designed to test:
...
Version 1.6.0 is a new release that adds a new monitoring execution mode for remora. This new mode is enabled by setting \verb+REMORA_MODE=MONITOR+, and continuously processes the data collected so that REMORA can be used as a real time monitoring system.
