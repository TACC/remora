...
REMORA is a tool to monitor runtime resource utilization in HPC environments. As of version 1.3.1 the suite contains code designed to test:
...
If you use REMORA, you can cite it:
