...
\begin{abstract}
Remora is a tool to monitor runtime resource utilization. As of version 1.3.1 the suite contains code designed to test:
...
Version 1.3.1 is a micro release where the \verb+remora_post+ executable has been modified to work with versions of Python older than 2.7.
\end{abstract}
...
First of all obtain the latest version tarball, currently remora-1.3.1.tar.gz, and expand it in a convenient location in your system:
