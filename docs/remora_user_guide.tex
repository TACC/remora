...
<<<<<<< HEAD
Version 1.8 is a feature release that adds support for MPI communication statistics, reduced overhead in  memory data collection and several other implementation improvements.
=======
Version 1.8 is a new release that includes MPI support and improved visualization of the results.
>>>>>>> bd701ed7bdecf998b922164b2afcf6c325c661b8
