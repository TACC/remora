...
As of version 2.1 the suite contains code designed to test:

\begin{itemize}
\item Memory: CPU and NVIDIA GPU
\item Load: CPU and NVIDIA GPU
\item IO: (when stats avaiable wo root perm.)
\item NUMA: local misses and page-size
\item Network topology
\item MPI Communication Statistics
\item Power Module Consumption: CPU and NVIDIA GPU
\item Temperature: CPU and NVIDIA GPU
\end{itemize}
...
Version 2.1 is a feature release that has been optimized to reduced collection overhead, programmed for attachment to
