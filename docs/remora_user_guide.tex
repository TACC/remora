...
We'd like to thank Jacob Pollack at Shell for his contributions to Ethernet monitoring, average CPU utilization post-processing and the use of 64 bit counters for infiniband monitoring when available.

We'd also like to acknowledge Kevin Manalo's (Ohio Supercomputing Center) suggestion to automate mlx device discovery, and wpoely86 for adding PBS support.
