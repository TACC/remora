...
First of all obtain the latest version tarball, currently remora-1.7.1.tar.gz \footnote{\href{https://github.com/TACC/remora/archive/v1.7.1.tar.gz}{https://github.com/TACC/remora/archive/v1.7.1.tar.gz}}, and expand it in a convenient location in your system:
