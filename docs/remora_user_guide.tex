...
First of all obtain the latest version tarball, currently remora-1.8.5.tar.gz \footnote{\href{https://github.com/TACC/remora/archive/v1.8.5.tar.gz}{https://github.com/TACC/remora/archive/v1.8.5.tar.gz}}, and expand it in a convenient location in your system:

\begin{verbatim}
    tar xzvf ./remora-1.8.5.tar.gz
\end{verbatim}
